...
TeemoUser::TeemoUser()
{
	...
	hoge_ = nya_graphic_->LoadFile("attack.png");


	nya_attack_->SettingGraphic(hoge_, 0);
...
void TeemoUser::Action(void)
{
	...
	NyaString::Write("teemo", white, 50, 110, "(50, 110) teemo x = %d", (int)ppx_teemo_->x_);
	NyaString::Write("teemo", white, 50, 130, "(50, 130) teemo y = %d", (int)ppx_teemo_->y_);
	...
	NyaString::Write("teemo", white, 50, 150, "(50, 150) teemo_image_id = %d", gpx4_teemo_->file_id_);
	NyaString::Write("teemo", white, 50, 170, "(50, 170) attack_image_id = %d", hoge_);
