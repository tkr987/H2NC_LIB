...
//	sync_movecount_ = 0;
	...
	iparam_exarms_->group_type_ = eOBJECT::NUM::USER;
	// Img Main 固定パラメータ
	...
	iparam_start_->group_type_ = eOBJECT::NUM::USER;
	// Img Sub 固定パラメータ
	...
	eparam_flash_->group_ = eOBJECT::NUM::USER_EFFECT;
	...
	PosManager::Generate(eOBJECT::NUM::USER, pparam_main_, POS_NAME_USER_MAIN);
	// その他 設定
