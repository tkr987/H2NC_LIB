...
void TeemoMission3::Create(void)
{
	...
	ctime = 56;
	AddTarget(ctime - 1, ctime + 50, new Target3Bordetella(SCREEN_CENTER_X, -100));
	AddTarget(ctime + 12, ctime + 40, new Target3Vibrio(SCREEN_CENTER_X - 260, -100, SCREEN_CENTER_X - 260, 150));
	AddTarget(ctime + 12, ctime + 40, new Target3Vibrio(SCREEN_CENTER_X - 180, -100, SCREEN_CENTER_X - 180, 120));
	AddTarget(ctime + 12, ctime + 40, new Target3Vibrio(SCREEN_CENTER_X - 100, -100, SCREEN_CENTER_X - 100, 150));
	AddTarget(ctime + 12, ctime + 40, new Target3Vibrio(SCREEN_CENTER_X + 100, -100, SCREEN_CENTER_X + 100, 150));
	AddTarget(ctime + 12, ctime + 40, new Target3Vibrio(SCREEN_CENTER_X + 180, -100, SCREEN_CENTER_X + 180, 120));
	AddTarget(ctime + 12, ctime + 40, new Target3Vibrio(SCREEN_CENTER_X + 260, -100, SCREEN_CENTER_X + 260, 150));
