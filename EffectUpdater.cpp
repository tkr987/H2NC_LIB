...
{
	DrawType1(eOBJECT::NUM::TARGET_EFFECT);
	DrawType1(eOBJECT::NUM::USER_EFFECT);
	DrawType1(eOBJECT::NUM::USER_ARMS_EFFECT);
	DrawType1(eOBJECT::NUM::TARGET_ARMS_EFFECT);
	DrawType2(eOBJECT::NUM::TARGET_EFFECT);
	DrawType2(eOBJECT::NUM::USER_EFFECT);
	DrawType2(eOBJECT::NUM::USER_ARMS_EFFECT);
	DrawType2(eOBJECT::NUM::TARGET_ARMS_EFFECT);
}
