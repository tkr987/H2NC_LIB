...
namespace H2NLIB
{
	...
	enum class eEVENT
	{
		...
		MISSION_CREATE, MISSION_RUN, MISSION_CONTINUE, MISSION_OVER, MISSION_CLEAR, MISSION_DELETE, MISSION_ALL_CLEAR,
		MISSION_REPLAY_CREATE, MISSION_REPLAY_RUN, MISSION_REPLAY_OVER, MISSION_REPLAY_CLEAR, MISSION_REPLAY_DELETE, MISSION_REPLAY_ALL_CLEAR,
